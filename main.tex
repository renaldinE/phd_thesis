...
\thesistitle{Thesis Title} % Your thesis title, print it with \ttitle
\supervisor{Prof. Dr. Charles Darwin} % Your supervisor's name, print it with \supname. Include academic title.
\coadvisor{Prof. Dr. Gregor Mendel} %Your co-advisors's name, print it with \coaname. Include academic title.
\firstname{John} % Your first name, print it with \fname. 
\lastname{Smith} % Your last name, print it with \lname .
\author{\fname~ \lname} % Your whole name made from your input, print it with \authorname.
\matriculationnumber{19-271-631} % Your matriculation number, print it with \matrnumber
\degree{PhD in Cell Biology} % Your degree name, print it with \degreename. 
...
\institute{\href{https://www.izb.unibe.ch/}{Institute of Cell Biology}} % Your department's name and URL, print it with \instname
...
\department{\href{https://www.izb.unibe.ch/}{Department of Biology}} % Your department's name and URL, print it with \deptname
\group{\href{https://www.GROUP_NAME.net/}{Group name}} % Your research group's name and URL, print it with \groupname
\subject{Cell biology} % Your subject area, print it with \subjectname
...
\include{Chapters/Chapter4_Disscusion} % Overall discussion and outlook/perspectives
