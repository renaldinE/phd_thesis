...
\addbibresource{{C:/Users/renald_e/Documents/BibTex/library.bib}} % The filename of the bibliography
...
\newacronym{hetp}{HETP}{height equivalent to theoretical plate}
\newacronym{eoi}{EoI}{end of irradiation}
\newacronym{eos}{EoS}{end of separation}
\newacronym{psi}{PSI}{Paul Scherrer Institut}
\newacronym{ptb}{PTB}{Physikalisch-Technische Bundesanstalt}
\newacronym{trt}{TRT}{targeted radionuclide therapy}
\newacronym{spect}{SPECT}{single-photon emission computed tomography}
\newacronym{hpge}{HPGe}{high-purity germanium}
\newacronym{icpms}{ICP-MS}{inductively coupled-plasma mass spectrometry}
\newacronym{icpoes}{ICP-OES}{inductively coupled-plasma optical emission spectrometry}
\newacronym{fep}{FEP}{full-energy peak}
\newacronym{IT}{IT}{internal transition}
\newacronym{dcbp}{DCBP}{Department of Chemistry, Biochemistry and Pharmacy}
\newacronym{iupac}{IUPAC}{International Union of Pure and Applied Chemistry}
\newacronym{ae}{AE}{Auger electron}
\newacronym{ce}{CE}{conversion electron}
\newacronym{mcrpc}{mCRPC}{metastatic castration-resistant prostate cancer}
\newacronym{net}{NET}{neuroendocrine tumor}
\newacronym{sirt}{SIRT}{selective internal radiation therapy}
\newacronym{mri}{MRI}{magnetic resonance imaging}
\newacronym{ca}{c.a.}{carrier-added}
\newacronym{nca}{n.c.a.}{non-carrier-added}
\newacronym{ill}{ILL}{Institut Laue-Langevin}
\newacronym{exc}{EXC}{extraction chromatography}
\newacronym{cex}{CEX}{cation exchange chromatography}
\newacronym{ahiba}{\textalpha{}-HIBA}{\textalpha{}-hydroxyisobutyric acid}
\newacronym{ptfe}{PTFE}{polytetraflouroethylene}
\newacronym{bs}{BS}{bottom Sykam}
\newacronym{ts}{TS}{top Sykam}
\newacronym{sinq}{SINQ}{Swiss Neutron Spallation Source}
\newacronym{peek}{PEEK}{polyether ether ketone}
\newacronym{bv}{BV}{bed volume}
\newacronym{sdd}{SDD}{source-to-detector distance}
\newacronym{hplc}{HPLC}{high-performance liquid chromatography}
\newacronym{let}{LET}{linear energy transfer}
\newacronym{dota}{DOTA}{2,2$^\prime$,2$^{\prime \prime}$,2$^{\prime \prime \prime} $-(1,4,7,10-tetraazacyclododecane-1,4,7,10-tetrayl)tetraacetic acid}
\newacronym{etoh}{EtOH}{ethanol}
\newacronym{cmi}{CMI}{Czech Metrology Institute}
\newacronym{mda}{MDA}{minimum detectable activity}
\newacronym{ama}{AMA}{apparent molar activity}
...
\include{Chapters/Introduction} % Comprehensive introduction into the field
